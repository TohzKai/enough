...
| ---------------------------------------------------------------------- | ----------------------------- | -------------------------------------------------------------------------- |
| the dataflow package (`src/dataflow/adapters/sqlite_enterprise.py`) | `SQLiteEnterpriseTransaction` | `_warnings=warnings`, class-level `_committed`                             |
| the dataflow package (`src/dataflow/adapters/postgresql.py`)        | `PostgreSQLTransaction`       | Same pattern                                                               |
| the dataflow package (`src/dataflow/adapters/mysql.py`)             | `MySQLTransaction`            | Same pattern                                                               |
...
| Location                                                        | Class                              |
| --------------------------------------------------------------- | ---------------------------------- |
| the kaizen package (`src/kaizen/memory/persistent_tiers.py`) | `WarmMemoryTier._get_connection()` |
| the kaizen package (`src/kaizen/memory/persistent_tiers.py`) | `ColdMemoryTier._get_connection()` |
